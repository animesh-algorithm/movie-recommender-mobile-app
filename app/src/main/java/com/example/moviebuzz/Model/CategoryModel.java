...
public class CategoryModel {
    String moviePoster,movieTitle,movieDuration,movieIMDB;
    ...
    public CategoryModel(String movieTitle) {
        this.movieId = movieTitle;
    }

    public CategoryModel(String title, String tagline, String overview, String poster_path, String movieId, String released, String plot,
